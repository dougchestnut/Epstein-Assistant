            ...
            <nav className="p-6 border-b border-zinc-900 bg-zinc-950 sticky top-0 z-20 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex space-x-2 bg-zinc-900 p-1 rounded-lg border border-zinc-800">
                        <Link
                            href="/"
                            className="px-4 py-2 text-sm font-medium rounded-md text-zinc-400 hover:bg-zinc-800 transition-colors"
                        >
                            Gallery
                        </Link>
                        <span className="px-4 py-2 text-sm font-medium rounded-md bg-zinc-800 text-emerald-500 shadow-sm">
                            Faces
                        </span>
                    </div>
                </div>
